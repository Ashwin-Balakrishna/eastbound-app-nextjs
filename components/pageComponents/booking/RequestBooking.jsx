      ...
      <div className="booking-overview-bottom">
        <div className="payment_modes_wrapper">
          ...
          <div class="form-check policy_details">
            <input class="form-check-input"  checked={accepted} onChange={()=>{setAccepted(!accepted)}} type="checkbox" id="requestbooking"/>
            <label class="form-check-label" for="requestbooking">
