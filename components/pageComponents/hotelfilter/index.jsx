...
const prices = [
  ...
  { id: 2, label: "₹5,000 - ₹10,000", count: 500, value: [5001, 10000], checked: false },
  { id: 3, label: "₹10,000 - ₹20,000", count: 500, value: [10001, 20000], checked: false },
  { id: 4, label: "> ₹20,000", count: 500, value: [20001, 20000000], checked: false },
];
...
const brand = [
  ...
  { id: 12, label: "Marriott International Hotels", value: "Marriott", count: 10, checked: false },
  { id: 13, label: "OYO", value: "OYO", count: 10, checked: false },
  { id: 14, label: "ROTANA HOTELS", value: "ROTANA HOTELS", count: 10, checked: false },
  { id: 15, label: "MINOR INTERNATIONAL GROUP", value: "MINOR INTERNATIONAL GROUP", count: 10, checked: false },
];

const amenities = [
  { id: 49, label: "Room service", value: "Room service", count: 10, checked: false },
  { id: 50, label: "Conference Room", value: "Conference Room", count: 10, checked: false },
  { id: 51, label: "Restaurant", value: "Restaurant", count: 10, checked: false },
  { id: 52, label: "Parking Facility", value: "Parking Facility", count: 10, checked: false },
  ...
  { id: 60, label: "Laundry service", value: "Laundry service", count: 10, checked: false },
  ...
  { id: 63, label: "Wheelchair", value: "Wheelchair", count: 10, checked: false },
...
const property = [
  ...
  { id: 24, label: "Apartments", value: "Apartment", count: 10, checked: false },
  { id: 25, label: "Guest House", value: "Guest House", count: 10, checked: false },
  { id: 26, label: "Private Villa", value: "Villa", count: 10, checked: false },
  { id: 27, label: "Resorts", value: "Resort", count: 10, checked: false },
  { id: 28, label: "Holiday Homes", value: "Holiday home", count: 10, checked: false },
...
const HotelFilter = ({ setCheckboxFilters, setCallhotel, setData, setFilterStatus }) => {
    ...
    <div className="filter__wrapper">
      ...
      <div className="filter__body">
              ...
              <div key={idx} className="filter__checkboxwrapper">
                <div className="custom-checkbox">
                  <input
                    ...
                    id={price.id}
                    onClick={(e) => {
                      updateFilterData("cost", idx, "checked", e.currentTarget.checked, false);
              ...
              <div className="filter__checkboxwrapper">
                <div className="custom-checkbox">
                  <input
                    ...
                    id={amenities.id}
                    onClick={(e) => {
                      updateFilterData("facilities", idx, "checked", !amenities.checked);

                      // setFacilities((prev) => {
                      //   return prev.map(data => {
                      //     if(data.id === amenities.id){
                      //       return {
                      //         ...data,
                      //         checked: !amenities.checked
                      //       }
              ...
              <div className="filter__checkboxwrapper">
                <div className="custom-checkbox">
                  <input
                    ...
                    id={rate.id}
                    onClick={(e) => {
                      updateFilterData("rating", idx, "checked", e.currentTarget.checked, false);
                  ...
                  <label htmlFor={rate.id}>
                    <span
                      className={
                        rate.value < 2 ? "rating bad" : rate.value > 1 && rate.value < 4 ? "rating avg" : "rating good"
                      }
                    >
                      {rate.label}
                    </span>
        ...
        <div className="filter__card">
          ...
          <button className="btn btn__primary apply_filter" type="submit">
            Apply Filter
          </button>
        </div>
      </div>
