...
const SearchHotels = ({
  ...
  // console.log("SEEARCHES=>",showSearch,setShowSearch)
  var today = new Date();
  ...
  //     `https://nodems.2hubdev.link/hotel/prices`,
  ...
  const submitForm = async (e) => {
    ...
    try {
      const path=`/srp?city=${city}&checkin=${booking.checkin}&checkout=${booking.checkout}&adult=${rooms
            .map((r) => r.adults)
