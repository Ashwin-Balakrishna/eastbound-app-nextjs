...
import InvoicePDF from '../components/pageComponents/pdf/InvoicePDF'
...
export default function Invoices(){
    ...
    async function getInvoices(){
        setLoading(true);
        try {
            const response = await fetchDataWithAuth(`${NODE_API_URL}/get-invoice-details?booking_id=${bId}`,'GET',null,null,null,null);
    ...
    return (
        <div className='container font-styles my-0' style={{width:'65% !important'}}>
            {
                loading 
                ?
