...
const NewHotel = () => {
  ...
  const [incValue, setIncValue] = useState(200);
  ...
  const getHotels = async () => {
    try {
      ...
      setDisplayData(res["data"]["response"].slice(0, 101));
                    ...
                    <div className="common-selectbox" onClick={toggleSort}>
                      ...
                      >
                        <ul className="list-unstyled" onClick={toggleSort}>
                          <li onClick={() => sortOption("Highest Price")}>
                            Highest Price{" "}
                          </li>
                          <li onClick={() => sortOption("Lowest Price")}>
                            Lowest Price{" "}
                          </li>
                  ...
                  <>
                    ...
                    <div className="card-tab-wrapper">
                      <div className="view-result">
                        <h1>Showing {totalHotels} results</h1>
                      </div>
                      <div className="card-view-wrappers">
                        ...
                        >
                          {totalData
                            .filter((h) => (fquery ? eval(fquery) : true))
                            .slice(0, datalen + 1)
                            .map((hotel, index) => {
                              // if(index===1){
                              //   setLoader(false)
